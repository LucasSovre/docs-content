...
3. Open `~/.aws/config` in a text editor and edit it as follows:
    ...
    <Message type="note">
      ...
      If you are facing issue like : Could not connect to the endpoint URL: "https://s3.fr-par.amazonaws.com/"
      You can user the following cli option : --endpoint-url=https://s3.fr-par.scw.cloud
    </Message>
