...
6. Select the **accessibility** of your Load Balancer. It can be either:
    - **Private**: A [private Load Balancer](/network/load-balancer/concepts/#private-load-balancer) will have no public IP address, and is only accessible from the Private Network(s) it is attached to. You can [attach your Load Balancer to a Private Network](/network/load-balancer/how-to/use-with-private-network/) after you have created it.
