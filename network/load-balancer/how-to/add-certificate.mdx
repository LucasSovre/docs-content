...
<Message type="note">
Let's Encrypt certificates can be only added to Load Balancers that have [public accessibility](/network/load-balancer/concepts/#accessibility), that is to say that have a public IP address. It is not possible to add Let's Encrypt certificates to private Load Balancers.
</Message>
