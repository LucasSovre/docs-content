...
- It can be attached to one or more [Private Networks](/network/vpc/concepts/#private-networks).
- It only listens to requests or connections sent to its interface(s) on Private Networks.
